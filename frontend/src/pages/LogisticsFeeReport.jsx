...
const LogisticsFeeReport = () => {
  const [reports, setReports] = useState([
    { orderId: "101", fee: "120", status: "Paid" },
    { orderId: "102", fee: "80", status: "Pending" },
    { orderId: "103", fee: "100", status: "Paid" },
  ]);
...
export default LogisticsFeeReport;
