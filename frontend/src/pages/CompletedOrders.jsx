      ...
      <div style={styles.container}>
        ...
        <div style={styles.banner}>
          <h2 style={styles.bannerTitle}>
            <CheckCircle size={24} color="#10B981" /> Completed Orders
          </h2>
          <p style={styles.bannerSubtitle}>
            Review and manage all completed orders efficiently
          </p>
        </div>
            ...
            <tbody>
              {completedOrders.map((order) => (
                <tr key={order.id} style={styles.row}>
                  ...
                  >
                    <User size={16} color="#2563EB" /> {order.username}
                  </td>
                  <td
                    style={{ ...styles.td, fontWeight: 700, color: "#047857" }}
                  >
                    {order.total}
                  </td>
                </tr>
